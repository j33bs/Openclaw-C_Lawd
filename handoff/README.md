...
- The current tracked wrapper does not emit nested `payload.local_dispatch.task_contract` fields because the current remote Dali watcher rejects that shape.
