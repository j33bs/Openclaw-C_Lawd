...
- `tacti_core.py` now depends on an explicit local tracker adapter layer in `tracker_adapters.py` instead of implicit class shapes in the tracker state modules.
