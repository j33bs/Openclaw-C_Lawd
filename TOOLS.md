...
- Keep the active Source UI / Dali endpoint in local env or operator notes, not hardcoded in tracked repo docs.
- When asked in direct chat or Telegram to add something to Source UI backlog, use the hidden control tag only on surfaces where it is actually wired:
