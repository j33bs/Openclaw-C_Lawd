...
- The current tracked wrapper carries the accepted local-dispatch lineage subset only. It does not emit nested `payload.local_dispatch.task_contract` fields because the current remote Dali watcher rejects that shape.
